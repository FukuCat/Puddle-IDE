...
public class StatementAnalyzer extends AbstractAnalyzer {
    ...
    private void evaluateAssignment(KotlinParser.AssignmentContext ctx){
        ...
        if(s == null)
            ...
            KotlinCodeValidator.reportCustomError(ErrorDictionary.TYPE_MISMATCH, ctx.getChild(0).getText() + " is of type: " + t.getName()+" Entered type: "+s.getName(), ctx.start.getLine());
        }
