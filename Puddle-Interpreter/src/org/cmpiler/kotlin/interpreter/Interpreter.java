...
public class Interpreter {
    ...
    private ParserRuleContext executionPoint;
    ...
    public void parseText(String text){
        KotlinCodeValidator.getInstance().reset();
        executionPoint = null;
    ...
    private void parseCode(KotlinParser parser){
        ...
        // run code
        executionPoint = parserRuleContext;
        //execute(parserRuleContext);
    }

    public void execute(){
        if(KotlinCodeValidator.getInstance().isValid() && executionPoint != null) {
    ...
    public void execute(ParserRuleContext parserRuleContext){
        if(KotlinCodeValidator.getInstance().isValid()) {
            Console.log(Console.DEV_CONSOLE, "Running code...");
            // tree walker
            ParseTreeWalker treeWalker = new ParseTreeWalker();
