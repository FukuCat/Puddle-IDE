...
classDeclaration returns [org.antlr.symtab.Scope scope]
...
functionDeclaration returns [org.antlr.symtab.Scope scope]
    : modifierList? FUN
    //(NL* typeParameters)?
    (NL* type NL* DOT)?
    (NL* typeParameters)?
...
functionValueParameter returns [org.antlr.symtab.Symbol symbol]
...
variableDeclaration returns [org.antlr.symtab.Symbol symbol]
    : simpleIdentifier (COLON type)?
    ;
