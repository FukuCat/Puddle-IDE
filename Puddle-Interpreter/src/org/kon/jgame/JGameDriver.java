...
public class JGameDriver {
	...
	public JGameDriver(String title, int width, int height, int fps, List<GameScene> scenes){
		GameSceneManager tempSceneMan = new GameSceneManager();
		// add scenes
	...
	public JGameDriver(String title, int width, int height, int fps, GameScene[] scenes){
		GameSceneManager tempSceneMan = new GameSceneManager();
		// add scenes
		for(GameScene s: scenes)
			tempSceneMan.addScene(s);
