...
public class JTextEditor extends JTextArea {
    public void inititalize(JFrame window, ArrayList<String> words, Color popUpBackground, Color textColor, Color suggestionFocusedColor, float opacity){
        AutoSuggestor aS = new AutoSuggestor(this, window, words, popUpBackground, textColor, suggestionFocusedColor, opacity);
    }
    ...
    class SuggestionLabel extends JLabel {
        ...
        public SuggestionLabel(String string, final Color borderColor, Color suggestionsTextColor, AutoSuggestor autoSuggestor) {
            ...
            this.textArea = autoSuggestor.getTextArea();
